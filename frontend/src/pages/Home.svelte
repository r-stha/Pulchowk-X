...
<div class="flex flex-col min-h-[calc(100vh-4rem)]">
  ...
  <section class="relative py-20 lg:py-32 overflow-hidden">
    <div class="absolute inset-0 -z-10">
      ...
      <div
        class="absolute top-0 right-0 -translate-y-12 translate-x-12 blur-3xl opacity-30"
      >
        <div class="aspect-square w-96 rounded-full bg-blue-400"></div>
      </div>
      <div
        class="absolute bottom-0 left-0 translate-y-12 -translate-x-12 blur-3xl opacity-30"
      >
        <div class="aspect-square w-96 rounded-full bg-purple-400"></div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <div class="max-w-3xl mx-auto space-y-8">
        <h1 class="text-5xl md:text-7xl font-bold tracking-tight text-gray-900">
          Navigate Pulchowk Campus like a <span class="text-blue-600">Pro</span>
        </h1>
        <p class="text-xl text-gray-600 leading-relaxed">
          The ultimate digital guide for IOE Pulchowk Campus. Find classrooms,
          departments, and amenities with our interactive map system.
        </p>
      ...
      <div class="grid md:grid-cols-3 gap-12">
        ...
        <div class="space-y-4">
          ...
          <p class="text-gray-600">
            Detailed map of the entire campus with search functionality to find
            any building or department instantly.
          </p>
        </div>
        ...
        <div class="space-y-4">
          ...
          <h3 class="text-xl font-bold text-gray-900">Location Search</h3>
          <p class="text-gray-600">
            Smart autocomplete search to help you find classrooms, labs, and
            administrative offices by name.
          </p>
        </div>
        ...
        <div class="space-y-4">
          <div
            class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center text-green-600"
          >
            <svg
              class="w-6 h-6"
              fill="none"
          ...
          <h3 class="text-xl font-bold text-gray-900">Mobile Friendly</h3>
          <p class="text-gray-600">
            Optimized for all devices so you can navigate the campus easily from
            your smartphone.
          </p>
        </div>
      </div>
