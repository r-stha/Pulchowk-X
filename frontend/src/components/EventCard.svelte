...
>
    ...
    <div class="relative h-56 overflow-hidden">
        ...
        {#if isOngoing}
            <div
                class="absolute inset-0 bg-blue-600/10 backdrop-blur-[2px]"
            ></div>
            <div
        ...
        >
            ...
            >
                <span
                    class="text-[10px] font-bold text-blue-600 uppercase mb-0.5"
                    >{new Date(event.eventStartTime).toLocaleDateString(
                        "en-US",
                        { month: "short" },
                    )}</span
                >
    ...
    <div class="p-6 flex flex-col flex-1">
        ...
        <p
            class="text-gray-500 text-sm leading-relaxed mb-6 line-clamp-2 flex-1"
        >
            {event.description ||
            ...
            >
                ...
                {#if event.venue}
                    <div class="flex items-center gap-1.5">
                        ...
                        <span class="font-medium truncate max-w-25"
                            >{event.venue}</span
                        >
                    </div>
                {/if}
