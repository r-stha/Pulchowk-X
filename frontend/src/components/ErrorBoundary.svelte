...
{#if error}
  <div class="min-h-[50vh] flex items-center justify-center p-4">
    <div
      class="bg-red-50 border border-red-200 rounded-xl p-8 max-w-md w-full text-center"
    >
      <div
      ...
      {#if import.meta.env.DEV}
        <details class="mt-6 text-left">
          ...
          <pre
            class="mt-2 p-3 bg-gray-100 rounded text-xs overflow-auto max-h-40 text-gray-600">
